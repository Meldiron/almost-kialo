<section class="flex flex-col space-y-6 md:space-y-10 py-10">
	...
	<p class="font-normal text-slate-900">
		The project is fully open sourced and can be found in a <a
			href="https://github.com/Meldiron/almost-kialo"
			class="hover:underline text-blue-500">GitHub repository</a
		>.
	</p>
	...
	<div class="flex justify-center">
		<a
			...
			class="inline-flex items-center py-3 px-6 font-medium text-gray-900 bg-white rounded-lg border border-gray-200 focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300"
		>
			<svg
				aria-hidden="true"
				focusable="false"
	...
	<p class="font-normal text-slate-900">
		...
		>. Check them out, they are the same thing but much more sophisticated! We are in no way
		affiliated or connected to Kialo website. This application came into existance as a way to
		showcase amazing project that can be built using
	...
	<div class="flex justify-center">
		<a
			href="https://www.kialo.com/"
			class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300"
		>
			Visit Kialo.com
			<svg
